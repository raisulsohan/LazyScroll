...
## 3. Web Page Access
LazyScroll interacts with web pages solely to detect HTML5 `<video>` and `<audio>` elements for adjusting and holding media playback volume when you hold `Alt` and scroll your mouse wheel. It does not read, modify, or transmit any page contents, cookies, or user credentials.
